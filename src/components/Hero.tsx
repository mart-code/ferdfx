...
export default function HeroCarousel() {
  ...
  return (
    <div className="relative w-full 2xl:h-[50vh] md:h-screen h-[100vh] overflow-hidden mb-36">
      ...
      >
        <h1 className="text-5xl font-bold 2xl:mt-[10vh] lg:mt-[30vh] mt-[10vh] px-2">
          Welcome to FerdFX Academy
        </h1>
        <p className="xl:text-base text-sm  max-w-2xl mt-4 w-3/4 mx-auto">
          Start your journey to mastering Forex Trading with one of the best in
          the world! Go from a beginner to an advanced FX trader with the one
          and only FERDINARD OKAFOR. Enroll now to gain access to over 80
          in-depth courses that carefully explains the extreme complexities of
          the forex market
        </p>
