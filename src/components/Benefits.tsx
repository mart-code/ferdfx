        ...
        <div className="flex flex-col xl:w-1/2 gap-10 mt-5">
          <SlideInSection direction="left">
            <div className="flex justify-start gap-2 items-start">
              <BookHeadphones size={50} className="basis-1/8" />
              <div className="flex flex-col gap-1 basis-7/8">
                ...
                <p className="font-light">
                  ...
                  rem minima quae minus tempora veritatis perferendis
                  dignissimos saepe, fuga optio!Lorem ipsum dolor sit amet
                  consectetur, adipisicing elit. Hic rem minima quae minus
                  tempora veritatis perferendis dignissimos saepe, fuga optio
                </p>
              </div>
            </div>
          </SlideInSection>
